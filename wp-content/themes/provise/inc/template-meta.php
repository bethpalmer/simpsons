 ...
 * @return array
 */
function provise_share_buttons( $context = 'loop', $args = array(), $config = array() ) {
	...
	if ( ! provise_is_meta_visible( $meta, $context ) ) {
		return;
	}
	...
	$default_config = apply_filters( 'provise_default_config_share_buttons', array(
	...
	$share_item_html = apply_filters( 'provise_share_button_html',
	...
	foreach ( (array) $networks as $id => $network ) :
		...
		$share_buttons .= sprintf(
			...
			esc_html__( 'Share on ', 'provise' ) . $network['name'],

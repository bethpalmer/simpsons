 ...
 * @return void
 */
function provise_main_menu() { ?>
	<nav id="site-navigation" class="main-navigation" role="navigation">
		<button class="menu-toggle" aria-controls="main-menu" aria-expanded="false">
			<i class="menu-toggle__icon fa fa-bars"></i>
			<span><?php echo esc_html__('Menu', 'provise') ?></span>
		</button>
		<div class="main-menu__wrap">
			<?php
				$args = apply_filters( 'provise_main_menu_args', array(
					'theme_location'   => 'main',
					'container'        => '',
					'menu_id'          => 'main-menu',
					'fallback_cb'      => 'provise_set_nav_menu',
					'fallback_message' => esc_html__( 'Set main menu', 'provise' ),
				) );
 ...
 * @return void
 */
function provise_footer_menu() { ?>
	<nav id="footer-navigation" class="footer-menu" role="navigation">
	<?php
		$args = apply_filters( 'provise_footer_menu_args', array(
			...
			'fallback_message' => esc_html__( 'Set footer menu', 'provise' ),
		) );
 ...
 * @return string
 */
function provise_get_social_list( $context, $type = 'icon' ) {
	static $instance = 0;
	$instance++;
	...
	$args = apply_filters( 'provise_social_list_args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'provise_set_nav_menu',
		'fallback_message' => esc_html__( 'Set social menu', 'provise' ),
	), $context, $type );
 ...
 * @return void
 */
function provise_set_nav_menu( $args ) {

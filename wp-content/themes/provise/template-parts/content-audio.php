...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'posts-list__item card' ); ?>>
	...
	<div class="post-list__item-content">
		...
		<?php $cats_visible = provise_is_meta_visible( 'blog_post_categories', 'loop' ) ? 'true' : 'false'; ?>
		...
		<div class="entry-content">
			<?php $embed_args = array(
				...
				if ( false === $embed_content ) {
					...
					$blog_content = get_theme_mod( 'blog_posts_content', provise_theme()->customizer->get_default( 'blog_posts_content' ) );
